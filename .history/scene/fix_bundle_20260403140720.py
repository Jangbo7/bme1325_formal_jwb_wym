...
with codecs.open('e:/shanghaitech/ai_hospital/bme1325_formal_jwb_wym-main/scene/bundle.js', 'r', 'utf-8') as f:
    content = f.read()
...
if old in content:
    ...
    with codecs.open('e:/shanghaitech/ai_hospital/bme1325_formal_jwb_wym-main/scene/bundle.js', 'w', 'utf-8') as f:
        f.write(content)
    print('Replacement successful')
else:
    print('Old string not found')
    idx = content.find('function getDoctorSystemPrompt')
    if idx != -1:
